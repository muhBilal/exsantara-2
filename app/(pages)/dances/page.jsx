      ...
      <div className={`bg-gray-100 h-full`}>
        <div className={`container`}>
          <section className={`flex justify-between items-center mb-10`}>
            <h1 className={`title`}>Tari Daerah</h1>
            <form className="w-80">
              <label
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7`}>              
              {dancesDisplay.map((dance, index) => (
                ...
                >
                  <img
                    src={
                      process.env.NEXT_PUBLIC_STORAGE + dance.image_thumbnail
                    }
                    alt="dances"
                  ...
                  <div className="rounded-bl-lg rounded-br-lg p-2">
                    ...
                    >
                      {
                        dance.name.length > 20 ? dance.name.substring(0, 20) + '...' : dance.name
                      }
                    </Link>
                    <div
                      className={`text-gray-500 text-md`}
                      dangerouslySetInnerHTML={{ __html: dance.desc.substring(0, 150) + '...' }}
                    />
                  </div>
                </Link>
              ))}
