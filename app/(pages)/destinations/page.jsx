...
export default function page() {
  ...
  const [destinationsDisplay, setDestinationsDsiplay] = useState([]);

  const handleSearch = (keyword) => {
    const filteredItems = destinations.filter((data) =>
        data.name.toLowerCase().includes(keyword.toLowerCase())
    );
    setDestinationsDsiplay(filteredItems);
  };
  ...
  const fetchData = async () => {
    ...
    setDestinationsDsiplay(res.data.data);
  };
        ...
        <div className={`bg-gray-100 h-full`}>
          <div className={`container`}>
            ...
            <section className="mt-5">
              {destinationsDisplay.length === 0 && <NotFound />}
              <div
              ...
              >
                {destinationsDisplay.map((destination, index) => (
                    ...
                    >
                      <img
                          src={
                              process.env.NEXT_PUBLIC_STORAGE + destination.image_thumbnail
                          }
                          alt="destinations"
                      ...
                      <div className="rounded-bl-lg rounded-br-lg p-2">
                        ...
                        <div
                            ...
                            dangerouslySetInnerHTML={{
                              __html: destination.desc.substring(0, 150) + "...",
                            }}
                        />
                      </div>
                    </Link>
