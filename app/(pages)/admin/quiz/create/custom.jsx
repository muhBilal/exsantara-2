...
const schema = yup.object().shape({
  ...
  expired_date: yup.date().typeError("Format tidak sesuai").required(),
...
export default function Page() {
  ...
  const handleCreate = async (data) => {
    ...
    questions.forEach((question) => {
      if (question !== "") {
        // Gunakan !== untuk memeriksa kesamaan
            ...
            <div className="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
              ...
              <form className={`px-10 pb-10`}>
                ...
                <div className="mb-6">
                  ...
                  <label
                    htmlFor="header"
                    className={`border border-gray-400 h-42 w-full cursor-expired_dateer flex items-center justify-center`}
                  >
                    {dirtyFields.image ? (
                      <img
